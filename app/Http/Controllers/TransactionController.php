...
class TransactionController extends Controller
{
    ...
    {
        // $transactions = Transaction::with('user:id,name', 'exam:id,title', 'program:id,name', 'tenant.user')->get();
        // return json_encode($transactions);
        if (request()->ajax()) {
            $transactions = Transaction::with('user:id,name', 'exam:id,title', 'program:id,name', 'tenant.user');
            ...
            return DataTables::of($transactions)
				...
				->addColumn('user', function ($row) {
                    ...
                    return $row->tenant ? $row->tenant->user->name : '';
    ...
    {
        $transaction->load('user:id,name', 'exam:id,title', 'program:id,name', );
