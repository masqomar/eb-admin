...
class TransactionDetailController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            $transactionDetails = TransactionDetail::with('transaction:id,user_id');

            return DataTables::of($transactionDetails)
                ->addColumn('transaction', function ($row) {
                    return $row->transaction ? $row->transaction->user_id : '';
    ...
    {
        $transactionDetail->load('transaction:id,user_id');
