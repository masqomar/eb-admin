<div class="row mb-2">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="number" name="grade_old" id="grade-old" class="form-control @error('grade_old') is-invalid @enderror" value="{{ (isset($grade) ? $grade->grade_old : old('grade_old')) ? old('grade_old') : '0.00' }}" placeholder="{{ __('Grade Old') }}" />
            @error('grade_old')
                <span class="text-danger">
                    {{ $message }}
                </span>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="number" name="grade" id="grade" class="form-control @error('grade') is-invalid @enderror" value="{{ (isset($grade) ? $grade->grade : old('grade')) ? old('grade') : '0.00' }}" placeholder="{{ __('Grade') }}" />
            @error('grade')
                <span class="text-danger">
                    {{ $message }}
                </span>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="number" name="is_finished" id="is-finished" class="form-control @error('is_finished') is-invalid @enderror" value="{{ isset($grade) ? $grade->is_finished : old('is_finished') }}" placeholder="{{ __('Is Finished') }}" />
            @error('is_finished')
                <span class="text-danger">
                    {{ $message }}
                </span>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="number" name="total_tolerance" id="total-tolerance" class="form-control @error('total_tolerance') is-invalid @enderror" value="{{ isset($grade) ? $grade->total_tolerance : old('total_tolerance') }}" placeholder="{{ __('Total Tolerance') }}" />
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="number" name="is_blocked" id="is-blocked" class="form-control @error('is_blocked') is-invalid @enderror" value="{{ isset($grade) ? $grade->is_blocked : old('is_blocked') }}" placeholder="{{ __('Is Blocked') }}" />
            @error('is_blocked')
                <span class="text-danger">
                    {{ $message }}
                </span>
