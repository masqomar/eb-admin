<div class="row mb-2">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="number" name="voucher_activated" id="voucher-activated" class="form-control @error('voucher_activated') is-invalid @enderror" value="{{ isset($transaction) ? $transaction->voucher_activated : old('voucher_activated') }}" placeholder="{{ __('Voucher Activated') }}" />
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="number" name="voucher_used" id="voucher-used" class="form-control @error('voucher_used') is-invalid @enderror" value="{{ isset($transaction) ? $transaction->voucher_used : old('voucher_used') }}" placeholder="{{ __('Voucher Used') }}" />
            @error('voucher_used')
                <span class="text-danger">
                    {{ $message }}
                </span>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="note" id="note" class="form-control @error('note') is-invalid @enderror" value="{{ isset($transaction) ? $transaction->note : old('note') }}" placeholder="{{ __('Note') }}" />
            @error('note')
                <span class="text-danger">
                    {{ $message }}
                </span>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="period" id="period" class="form-control @error('period') is-invalid @enderror" value="{{ isset($transaction) ? $transaction->period : old('period') }}" placeholder="{{ __('Period') }}" />
            @error('period')
                <span class="text-danger">
                    {{ $message }}
                </span>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="aff-id">{{ __('Aff Id') }}</label>
            <input type="number" name="aff_id" id="aff-id" class="form-control @error('aff_id') is-invalid @enderror" value="{{ isset($transaction) ? $transaction->aff_id : old('aff_id') }}" placeholder="{{ __('Aff Id') }}" />
            @error('aff_id')
                <span class="text-danger">
                    {{ $message }}
                </span>
