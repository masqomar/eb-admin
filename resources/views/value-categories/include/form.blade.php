<div class="row mb-2">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="number" name="assessment_type" id="assessment-type" class="form-control @error('assessment_type') is-invalid @enderror" value="{{ (isset($valueCategory) ? $valueCategory->assessment_type : old('assessment_type')) ? old('assessment_type') : '1' }}" placeholder="{{ __('Assessment Type') }}" />
