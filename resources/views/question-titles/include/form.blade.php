<div class="row mb-2">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="number" name="assessment_type" id="assessment-type" class="form-control @error('assessment_type') is-invalid @enderror" value="{{ (isset($questionTitle) ? $questionTitle->assessment_type : old('assessment_type')) ? old('assessment_type') : '1' }}" placeholder="{{ __('Assessment Type') }}" />
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="number" name="show_answer" id="show-answer" class="form-control @error('show_answer') is-invalid @enderror" value="{{ isset($questionTitle) ? $questionTitle->show_answer : old('show_answer') }}" placeholder="{{ __('Show Answer') }}" />
            @error('show_answer')
                <span class="text-danger">
                    {{ $message }}
                </span>
