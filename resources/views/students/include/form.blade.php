<div class="row mb-2">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror" placeholder="{{ __('Address') }}" required>{{ isset($student) ? $student->address : old('address') }}</textarea>
            @error('address')
                <span class="text-danger">
                    {{ $message }}
                </span>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="number" name="is_member" id="is-member" class="form-control @error('is_member') is-invalid @enderror" value="{{ isset($student) ? $student->is_member : old('is_member') }}" placeholder="{{ __('Is Member') }}" />
            @error('is_member')
                <span class="text-danger">
                    {{ $message }}
                </span>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <textarea name="member_access" id="member-access" class="form-control @error('member_access') is-invalid @enderror" placeholder="{{ __('Member Access') }}">{{ isset($student) ? $student->member_access : old('member_access') }}</textarea>
            @error('member_access')
                <span class="text-danger">
                    {{ $message }}
                </span>
